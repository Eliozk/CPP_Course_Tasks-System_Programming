...
void Board::initializeBoard()
{
    ...
    // For demonstration purposes, print out the tiles and their vertices
    cout << "\nFor demonstration purposes, print out the tiles and their vertices:" << endl;
...
bool Board::checkInitialPlacement(Player &player, size_t vertexIndex, size_t vertexIndex2)
{
    ...
    vertex.setOwner(player.getNumberOfPlayer());

    // Set the owner of the edge to the playerID
    boardEdges[edgeIndex].setOwner(player.getNumberOfPlayer());
...
bool Board::checkSettlementPlacement(int playerId, size_t vertexIndex)
{
    // Check if vertexIndex is valid
