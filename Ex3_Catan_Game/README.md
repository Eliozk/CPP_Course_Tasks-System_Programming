run order without makefile: g++ -o demoMain src/demoMain.cpp src/Tile.cpp src/Settlement.cpp src/Player.cpp src/Board.cpp -I./hppFiles
# קטאן - מחלקות וירושה
...
### מהלך המשחק
כל שחקן מתחיל את המשחק עם 2 יישובים ו-2 קטעי דרך המעניקים לו S2 נקודות ניצחון. בנוסף, השחקנים מקבלים משאבים התחלתיים בהתאם למקומות שבהם הם מיקמו את היישובים (משאב אחד מכל משאב אפשרי).
